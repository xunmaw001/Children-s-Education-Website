    ...
    */
    ...
    public R save(@RequestBody WenzhangEntity wenzhang, HttpServletRequest request){
        ...
        Wrapper<WenzhangEntity> queryWrapper = new EntityWrapper<WenzhangEntity>()
            ...
            .eq("vipwenzhang_types", wenzhang.getVipwenzhangTypes())
            .eq("nianlingduan_types", wenzhang.getNianlingduanTypes())
...
//                            wenzhangEntity.setVipwenzhangTypes(Integer.valueOf(data.get(0)));   //是否vip文章 要改的
//                            wenzhangEntity.setNianlingduanTypes(Integer.valueOf(data.get(0)));   //适合年龄段 要改的
