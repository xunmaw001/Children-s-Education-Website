...
public class ShipinZhangjieCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShipinZhangjieCollectionEntity() {

	}

	public ShipinZhangjieCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "ShipinZhangjieCollection{" +
            "id=" + id +
            ", shipinZhangjieId=" + shipinZhangjieId +
            ", yonghuId=" + yonghuId +
            ", shipinZhangjieCollectionTypes=" + shipinZhangjieCollectionTypes +
