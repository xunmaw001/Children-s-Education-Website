...
var centerMenu = [
    ...
    ,{
        name: '章节收藏',
        url: '../shipinZhangjieCollection/list.html'
    }
    ,{
        name: '文章收藏',
    ...
    ,{
        name: '文章目录收藏',
        url: '../wenzhangMuluCollection/list.html'
    }
...
var adminurl =  "http://localhost:8080/ertongjiaoyu/admin/dist/index.html#/login";
