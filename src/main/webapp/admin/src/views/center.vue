  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='是否vip' prop="vipTypes">
                 <el-select v-model="ruleForm.vipTypes" disabled  placeholder='请选择是否vip'>
                     <el-option
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.vipTypes)&& 'yonghu'==this.flag){
