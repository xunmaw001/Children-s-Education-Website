        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否vip文章" prop="vipwenzhangTypes">
                        <el-select v-model="ruleForm.vipwenzhangTypes" :disabled="ro.vipwenzhangTypes" placeholder="请选择是否vip文章">
                            <el-option
                                v-for="(item,index) in vipwenzhangTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否vip文章" prop="vipwenzhangValue">
                        <el-input v-model="ruleForm.vipwenzhangValue"
                            placeholder="是否vip文章" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="文章介绍" prop="wenzhangContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.wenzhangContent" label="文章介绍" prop="wenzhangContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   vipwenzhangTypes: [
                              { required: true, message: '是否vip文章不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=vipwenzhang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.vipwenzhangTypesOptions = data.data.list;
                    }
                });
                this.$http({
