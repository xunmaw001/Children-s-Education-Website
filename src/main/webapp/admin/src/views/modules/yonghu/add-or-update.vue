        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否vip" prop="vipTypes">
                        <el-select v-model="ruleForm.vipTypes" :disabled="ro.vipTypes" placeholder="请选择是否vip">
                            <el-option
                                v-for="(item,index) in vipTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否vip" prop="vipValue">
                        <el-input v-model="ruleForm.vipValue"
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   vipTypes: [
                              { required: true, message: '是否vip不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=vip_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.vipTypesOptions = data.data.list;
                    }
                });
