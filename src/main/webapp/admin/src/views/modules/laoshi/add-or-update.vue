    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="毕业于哪一年" prop="biyenian">
                       <el-input v-model="ruleForm.biyenian"
                                 placeholder="毕业于哪一年" clearable  :readonly="ro.biyenian"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="毕业于哪一年" prop="biyenian">
                           <el-input v-model="ruleForm.biyenian"
                                     placeholder="毕业于哪一年" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="shanchang">
                       <el-input v-model="ruleForm.shanchang"
                                 placeholder="擅长" clearable  :readonly="ro.shanchang"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="擅长" prop="shanchang">
                           <el-input v-model="ruleForm.shanchang"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   biyenian: [
                              { required: true, message: '毕业于哪一年不能为空', trigger: 'blur' },
                          ],
                   shanchang: [
